...
p3
```
This proves that mod2 is not necessarly the best model. It does a good job at predicting the varience of cyl=4, but very poorly at predicting with type 6 and 8. 
